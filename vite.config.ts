...
export default defineConfig(({ mode }) => {
	...
	return {
		...
		build: {
			// Build output goes to dist/ at the project root so Electron's loadFile can find it.
			// (Was ../../portals for the SEMOSS publishing flow — restore that if you need to publish.)
			outDir: "../dist",
			emptyOutDir: true,
		},
